...
?>
        ...
        <head>
            ...
            <link rel="stylesheet" href="../style/store/initializeAccount.css">
        ...
        <body class="text-center">
            ...
            <main class="form-register">
                <form action="../backend/store/setAccount.php" method="POST">
            ...
            <!-- Custom JS -->
            <script src="../script/store/initializeAccount.js"></script>
        </body>
