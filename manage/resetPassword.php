...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="../style/manage/resetPassword.css">
        <link rel="shortcut icon" href="../src/image/ico.png" type="image/x-icon">
        <title>業務後台系統 | 變更密碼</title>
    </head>
    ...
    <body class="text-center">
        ...
        <main class="form-register">
            <form action="../backend/manage/setPassword.php" method="POST">
        ...
        <!-- Custom JS -->
        <script src="../script/manage/resetPassword.js"></script>
    </body>
